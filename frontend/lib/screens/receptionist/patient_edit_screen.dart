...
class PatientEditScreen extends StatefulWidget {
  PatientEditScreen({super.key, this.fpm});

  FullPatientModel? fpm;
...
class _PatientEditScreenState extends State<PatientEditScreen> {
  ...
  void initState() {
    ...
    _nameController.text = widget.fpm!.name!;
    _emailController.text = widget.fpm!.email!;
    _phoneController.text = widget.fpm!.phnNumber!;
    _addressController.text = widget.fpm!.address ?? "";
    _medDetails.text = widget.fpm!.medDetails ?? "";
    _latestMedDetails.text = widget.fpm!.latestMedDetails ?? "";
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GetTextFormFieldWidget(
                      ...
                      fieldActive: userType == "Doctor" ? false : true,
                      //width: width * .4,
                    ),
                    const SizedBox(height: 15),
                    GetTextFormFieldWidget(
                    ...
                    SizedBox(
                      ...
                      child: ConstrainedBox(
                        ...
                        child: TextFormField(
                          ...
                          enabled: userType == "Doctor" ? false : true,
                          maxLines: 250,
                      ...
                      child: GetButtonWidget(
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            FullPatientModel _pm = FullPatientModel(
                            ...
                            await _apiServices.updatePatient(_pm);
                            if (userType == "Doctor") {
